import PrettyQR from '../../src/index.js'
  ...
  try {
    const options = {
      ...
      style: {
        ...
        eyeStyle: eyeStyleSelect.value as any,
        patternStyle: patternStyleSelect.value as any,
      ...
      logo: logoInput.value ? {
        src: logoInput.value,
        size: Math.floor(parseInt(sizeInput.value) * parseInt(logoSizeInput.value) / 100)
      } : undefined
    }
